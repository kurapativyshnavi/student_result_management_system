...
<body class="bg-dark">
  ...
  <main id="main" >
		...
		<h4 class="text-white text-center"><b><?php echo $_SESSION['system']['name'] ?> - Admin</b></h4>
  		<div id="login-center" class="bg-dark row justify-content-center" style="display: flex;justify-content: center;gap: 40px;flex-wrap: wrap;padding: 20px;">
  			<div class="card col-md-4">
  				<div class="card-body">
          <label class="control-label d-flex justify-content-center align-items-center text-dark">Admin Login</label>
  					<form id="login-form">
        ...
        <!-- <div class="card col-md-4">
  				<div class="card-body">
          <label class="control-label d-flex justify-content-center align-items-center text-dark">Student Login</label>
  					<form id="login-form-student">
  						<div class="form-group">
  							<label for="username1" class="control-label text-dark">Student Code</label>
  							<input type="text" id="username1" name="stu_code" class="form-control form-control-sm">
  						</div>
  						<div class="form-group">
  							<label for="password1" class="control-label text-dark">Password</label>
  							<input type="password" id="password1" name="stu_password" class="form-control form-control-sm">
  						</div>
  						<div class="w-100 d-flex justify-content-center align-items-center">
                <button class="btn-sm btn-block btn-wave col-md-4 btn-primary m-0 mr-1">Student Login</button>
              </div>
  					</form>
  				</div>
  			</div> -->
